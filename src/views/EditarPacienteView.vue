<template>
    <div class="editar_paciente">
        ...
        <div class="card-header py-3">
            <h4 class="m-0 font-weight-bold text-dark text-center">Editar Paciente {{ this.$route.params.bi }}
            </h4>
        </div>
...
export default {
    ...
    methods: {
        ...
        user: function (event) {
            ...
            axios.get('http://localhost/historico_mais/api/registar_paciente', dados, {
                headers: {
        ...
        listar() {
            ...
            axios.get('http://localhost/historico_mais/api/paciente?bi=' + this.$route.params.bi + '', {
                ...
                .then((res) => {
                    ...
                    this.nome = res.data.data[0].nome
                   // this.date = res.data.data[0].nome
                    this.doc_identificacao = res.data.data[0].BI
                    this.sexo = res.data.data[0].sexo
                    this.numero = res.data.data[0].numero
